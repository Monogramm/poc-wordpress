                  ...
                  <input type="text" name="title" value="<?php if (isset($_POST['title']))
{
    echo $_POST['title'];
                ...
                <div class="form-group">
                  ...
                  <textarea name="description" id="inputDescription" class="form-control" ><?php if (isset($_POST['description']))
{
    echo $_POST['description'];
                ...
                <div class="form-group">
                  ...
                  <input type="date" name="date" value="<?php if (isset($_POST['date']))
{
    echo $_POST['date'];
                ...
                <div class="form-group">
                  ...
                  <input type="time" name="start_time" value="<?php if (isset($_POST['start_time']))
{
    echo $_POST['start_time'];
} ?>" class="form-control" id="inputStartTime" >
                    <p class="help-block">Example : 12:05 Am</p>
                    
                </div>  
                <div class="form-group">
                  <label for="inputEndTime">End Time</label>
                  <input type="time" name="end_time" value="<?php if (isset($_POST['end_time']))
{
    echo $_POST['end_time'];
} ?>" class="form-control" id="inputEndTime" >
                    <p class="help-block">Example : 12:05 Am</p>
                </div>
                <div class="form-group">
                  <label for="inputCategory">Event Category</label>
                  <input type="text" name="event_category" value="<?php if (isset($_POST['event_category']))
{
    echo $_POST['event_category'];
} ?>" class="form-control" id="inputCategory" >
                    <p class="help-block">Add Event Category</p>
                </div>  
                <div class="form-group">
                  <label for="inputCategory">Tags</label>
                  <input type="text" name="tags" value="<?php if (isset($_POST['tags']))
{
    echo $_POST['tags'];
